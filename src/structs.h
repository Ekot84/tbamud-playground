...
#define CON_ACCOUNT_NAME 33
#define CON_ACCOUNT_CHECK_EXIST 34
#define CON_ACCOUNT_PASSWORD 35
#define CON_ACCOUNT_NEW_PASS 36
#define CON_ACCOUNT_CONFIRM_PASS 37
#define CON_ACCOUNT_MENU 38
#define CON_ACCOUNT_CHAR_SELECT 39
#define CON_ACCOUNT_CHAR_DELETE_SELECT   40
#define CON_ACCOUNT_CHAR_DELETE_CONFIRM  41
#define CON_ACCOUNT_CHANGE_PASS 42
...
#define ITEM_STASH     25		/**< Item is a stash, used for storing items */
...
struct descriptor_data
{
  ...
  struct list_data * events;
  char account_name[MAX_INPUT_LENGTH];     /* Temporary during login */
  char account_password[MAX_INPUT_LENGTH]; /* Temp during creation */
  struct account_data *account;            /* Loaded account */
  int bad_account_pws;                    /* number of bad pw attemps this login */ 
  int character_to_delete;           /* Character to delete */
};
